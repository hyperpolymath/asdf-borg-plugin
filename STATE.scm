...
;; STATE.scm - Project state tracking for asdf-borg-plugin
;; Media-Type: application/vnd.state+scm

(define-state asdf-borg-plugin
  (metadata
    (version "0.1.0")
    (schema-version "1.0.0")
    (created "2026-01-30")
    (updated "2026-01-30")
    (project "asdf-borg-plugin")
    (repo "hyperpolymath/asdf-borg-plugin"))

  (project-context
    (name "asdf-borg-plugin")
