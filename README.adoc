...
:url-repo: https://github.com/hyperpolymath/asdf-borg-plugin
...
image:https://img.shields.io/github/license/hyperpolymath/asdf-borg-plugin?style=flat-square[License,link=LICENSE]
image:https://img.shields.io/github/v/release/hyperpolymath/asdf-borg-plugin?style=flat-square[Release,link={url-repo}/releases]
image:https://img.shields.io/github/actions/workflow/status/hyperpolymath/asdf-borg-plugin/ci.yml?branch=main&style=flat-square[Build Status,link={url-repo}/actions]
image:https://img.shields.io/badge/asdf-plugin-blue?style=flat-square[asdf Plugin,link={url-asdf}]

[.lead]
An {url-asdf}[asdf] plugin to install and manage {url-tool}[Borg] versions.
...
Borg is an upstream tool managed by this plugin. Refer to the official
...
|**Version Switching**
|Switch between Borg versions per project

|**Project Isolation**
|Pin Borg per repository via `.tool-versions`

|**Reproducible Builds**
|Align CI/CD and developer environments to the same Borg version
...
=== Installing Borg Versions

[source,bash]
----
asdf list all borg
asdf install borg latest
asdf install borg 0.1.0
----
...
[source,bash]
----
asdf global borg 0.1.0
asdf local borg 0.1.0
asdf current borg
borg --version
----
...
* Ensure `borg` is on PATH after installation.
* Verify the installed version with `borg --version`.
